...
then
    ...
    echo "Bootnot is not running, starting it"
...
# ./scripts/startNode.sh /node/env/node 39393 127.0.0.1 8545 clique,personal,db,eth,net,web3,txpool,miner /node/pre-defined/password.txt
